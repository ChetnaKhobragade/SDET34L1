...
public class TC_48 {
	...
	public static void main(String[] args) throws Throwable {
		...
		driver.findElement(By.id("show_Contacts_Services")).click();
		driver.findElement(By.xpath("//input[@title='Select Services']")).click();
		
		String parent= driver.getWindowHandle();
		WebDriverLibrary.switchToWindow(driver);
	//	WebDriverLibraries.switchToWindowBasedOnTitle(driver, "Accounts&action");
//		String parent = driver.getWindowHandle();
...
//		}
		...
		//WebDriverLibraries.switchToWindowBasedOnTitle(driver, "Services&return");
		
		WebElement ele = driver.findElement(By.name("search"));
		WebDriverLibrary.explicitlyWait(driver, 10);
		WebDriverLibrary.waitUntillElementClickable(ele);
		
		driver.findElement(By.xpath("//input[@id='search_txt']")).sendKeys("SER1");
		driver.findElement(By.xpath("//input[@name='search']")).click();

		WebDriverLibrary.switchToParentWindow(driver, parent);
