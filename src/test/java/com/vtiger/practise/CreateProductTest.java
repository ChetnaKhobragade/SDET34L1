...
public class CreateProductTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		if (driver.getTitle().contains("Home")) {
			ExcelLibrary.setDataInExcel("product", 8, 4, "Home page diaplayed");
			ExcelLibrary.setDataInExcel("product", 8, 5, "pass");
		}
		...
		if (title.contains("Products")) {
			ExcelLibrary.setDataInExcel("product", 9, 4, "Products page diaplayed");
			ExcelLibrary.setDataInExcel("product", 9, 5, "Pass");
		}
		...
		if (title2.contains("Creating New Product")) {
			ExcelLibrary.setDataInExcel("product", 10, 4, "Create product page diaplayed");
			ExcelLibrary.setDataInExcel("product", 10, 5, "Pass");
		}
		...
		{
			ExcelLibrary.setDataInExcel("product", 11, 4, "Data is created as expected");
			ExcelLibrary.setDataInExcel("product", 11, 5, "Pass");
			ExcelLibrary.setDataInExcel("product", 2, 3, "Pass");
		...
		{
			ExcelLibrary.setDataInExcel("product", 13, 4, "Login page diaplayed");
			ExcelLibrary.setDataInExcel("product", 13, 5, "pass");
		}
